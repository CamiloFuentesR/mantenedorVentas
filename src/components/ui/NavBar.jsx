        ...
        <>
            ...
            <nav className="_home_nav bg-dark sticky-top">
                <div className="_auth_house_btn btn btn-sm">   
                    <Link to={"auth/home"}>
                <svg xmlns="http://www.w3.org/2000/svg" className="  icon icon-tabler icon-tabler-smart-home" width="44" height="44" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#fcf9fa" fill="none" strokeLinecap="round" strokeLinejoin="round">
